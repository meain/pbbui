const data = {
  ...
  TRAPS: {
    ...
    'Ignore terminal interrupt (CTRL+C, SIGINT)': ['', '```shell', "trap '' INT", '```', ''],
    'React to window resize': ['', '```shell', "trap 'code_here' SIGWINCH", '```', ''],
    'Do something before every command': ['', '```shell', "trap 'code_here' DEBUG", '```', ''],
  ...
  'INTERNAL VARIABLES': {
    ...
    'Get the location to the `bash` binary': ['', '```shell', '"$BASH"', '```', ''],
    ...
    'Get the architecture of the Operating System': ['', '```shell', '"$HOSTTYPE"', '```', ''],
  ...
  OTHER: {
    ...
    'Bypass shell aliases': ['', '```shell', 'ls', '', '\\ls', '```', ''],
    'Bypass shell functions': ['', '```shell', 'ls', '', 'command ls', '```', ''],
